 ...
 *
 */
package net.mcreator.terramiraproject;
...
@Mod("terramiraproject")
public class TerramiraprojectMod {
	public static final Logger LOGGER = LogManager.getLogger(TerramiraprojectMod.class);
	public static final String MODID = "terramiraproject";

	public TerramiraprojectMod() {
